...
if __name__ == "__main__":
    ...
    # for k in range(100):
    # grad_echo(lo_freq=1, trs=1, plot_rx=True, init_gpa=True, dbg_sc=1, plot_sequence=True)
    # radial(trs=100, init_gpa=True, plot_rx=True, plot_sequence=True)
    # turbo_spin_echo(trs=2, echos_per_tr=4, plot_sequence=True, tr_pause_duration=100000)
